      ...
      <div className="footer-container">
        <div className="footer-section">
          ...
          <div className="theme-switcher">
            ...
            <button 
              className={`theme-btn theme-auto ${theme === 'auto' ? 'active' : ''}`}
        ...
        <div className="footer-section">
          ...
          <p className="footer-address">г. Санкт-Петербург, пр. Королева, 48/6</p>
        </div>
      </div>
      <div className="footer-bottom">
        <p className="footer-legal">
          Все фото и видео материалы принадлежат владельцам сайта. Использование без согласия владельцев запрещено.
        </p>
